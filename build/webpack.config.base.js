    ...
    },
    {
      ...
      options: {
        ...
        name(resourcePath, resourceQuery) {
         ...
         let target = utils.assetsPath1(resourcePath, entry)
          if (process.env.NODE_ENV === 'development') {
            return '[folder]/[path][name].[ext]';
          }

          return (target ? target : 'static') + '/img/[name][contenthash].[ext]';
        },
      ...
      options: {
        ...
        name(resourcePath, resourceQuery) {
         ...
         let target = utils.assetsPath1(resourcePath, entry)
          ...
          return (target ? target : 'static') + '/media/[name][contenthash].[ext]';
        },
      ...
      options: {
        ...
        name(resourcePath, resourceQuery) {
         ...
         let target = utils.assetsPath1(resourcePath, entry)
          ...
          return (target ? target : 'static') + '/fonts/[name][contenthash].[ext]';
        },
